            ...
            <section id='projectSection' className='hideMe'>
                <div className='center'>
                    ...
                    <form action="" className='project-form inline-block project-summary' id=''>
                        <input className="longer-input" id='projectName' type="text" value="" required />
                        <input className="longer-input" id='projectPredeccesor' type="text" value="" required />
                        <input className="shorter-input" id='projectDuration' type="text" value="" required />
                        <input className="shorter-input" id='projectStart' type="text" value="" required />
